...
const DEFAULT_CONFIG: DbConfig = {
    url: import.meta.env.VITE_SURREAL_URL
        ? import.meta.env.VITE_SURREAL_URL.endsWith("/rpc")
            ? import.meta.env.VITE_SURREAL_URL
            : `${import.meta.env.VITE_SURREAL_URL}/rpc`
...
export async function signup(
    ...
    try {
        ...
        if (e && typeof e === "object") {
            ...
            if ("information" in e && typeof e.information === "string")
                details = `${details}: ${e.information}`;
    ...
    try {
        ...
        if (getConnectionState() === ConnectionState.CONNECTED) {
            try {
                ...
                console.warn(
                    "Error invalidating token on server:",
                    invalidateError,
                );
            }
        }
